...
your installer's floor, the VC++ runtime (UCRT via KB2999226 / vc_redist),
and whatever your own native code imports are yours to handle. Windows 7
itself needs SHA-2 code-signing support (KB4474419 + KB4490628) for signed
drivers and KB2670838 for the D3D11.1 path ANGLE prefers.
